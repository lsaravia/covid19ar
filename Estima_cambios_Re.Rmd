...
```{r Refectivo, echo=FALSE, tidy=TRUE, message=FALSE, warning=FALSE,cache=TRUE}
require(EpiEstim)
...
El **pico de la incidencia fue el `r cor_incidence_peak`**
...
plot(cor_incidence_obj) + geom_vline(xintercept = cor_incidence_peak, 
    col = "red", lty = 2) + labs(title = "Casos diarios **locales** confirmados por laboratorio Coronavirus Argentina", 
    subtitle = "(La linea roja indica el pico de incidencia)")
...
plot(cor_incidence_obj1) + geom_vline(xintercept = cor_incidence_peak, 
     col = "red", lty = 2) + labs(title = "Casos diarios confirmados por laboratorio Coronavirus Argentina", 
                                  subtitle = "(La linea roja indica el pico de incidencia)") + theme_bw()
...
# str(cor_incidence_fit$after)
# get_info(cor_incidence_fit$before, "r")
# get_info(cor_incidence_fit$before, "r.conf")
# get_info(cor_incidence_fit$after, "r")
# get_info(cor_incidence_fit$after, "r.conf")
# get_info(cor_incidence_fit$after, "halving")
# get_info(cor_incidence_fit$after, "halving.conf")
...
* Esta estimacion de proyecciones requiere la estimación del R0 para la fase creciente y decreciente, basado en [@Nouvellet2018]. Cuando tomamos los casos locales, si dividimos en dos fases por el pico de incidencia la segunda fase no es decreciente.  
